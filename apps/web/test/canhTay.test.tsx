...
describe('điểm gắn vai xoay theo ngực', () => {
  ...
  const CON: Array<[string, number, number]> = [
    ...
    ['rong', 0.24, 0.42], ['ran', 0.18, 0.44], ['nguaxanh', 0.24, 0.44], ['ngua', 0.24, 0.44],
    ['sonduong', 0.22, 0.42], ['de', 0.22, 0.4], ['khi', 0.2, 0.38], ['khido', 0.2, 0.38],
    ['vittroi', 0.22, 0.38], ['cho', 0.22, 0.38],
  ];
